# 🏗️ Pravah CDN — Infrastructure Architecture & Automation

This directory contains the complete infrastructure, containerization, orchestration, and Infrastructure as Code (IaC) tooling powering the **Pravah Distributed CDN**.
...
```
infra/
├── docker/                    # 1. Containerization & Local Development
...
│
├── k8s/                       # 2. Kubernetes Production Orchestration
...
│
├── helm/                      # 3. Cloud-Native Packaging
│   └── pravah-cdn/            # Production Helm chart (Chart.yaml & values.yaml)
│
└── terraform/                 # 4. Cloud Infrastructure as Code (IaC)
...
## 🗺️ Tooling Matrix & When to Use What

| Development Stage | Recommended Tool | Directory | Command |
| :--- | :--- | :--- | :--- |
| **Local Development ($0)** | Docker Compose | [`infra/docker/`](./docker/README.md) | `make dev` |
...
* 🐳 [**Docker & Container Guide**](./docker/README.md)
* ☸️ [**Kubernetes Manifests & Topology**](./k8s/README.md)
* ⚡ [**Kubernetes Distributed k6 Benchmarks**](./k8s/benchmarks/README.md)
* ⎈ [**Helm Packaging Guide**](./helm/README.md)
* 🌍 [**Terraform Multi-Region IaC**](./terraform/README.md)
